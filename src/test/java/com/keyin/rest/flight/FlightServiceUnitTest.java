...
//        req.setAirportTakeOffId(1L);
//        req.setAirportLandingId(3L);
...
//        when(airportRepository.findById(1L)).thenReturn(Optional.of(airportTake));
//        when(airportRepository.findById(3L)).thenReturn(Optional.of(airportLand));
